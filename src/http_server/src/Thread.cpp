...
Thread::Thread()
{
    ...
    if (schedParam.sched_priority < MIN_PRIORITY)
        schedParam.sched_priority = MIN_PRIORITY;
    else if (schedParam.sched_priority > MAX_PRIORITY)
...
/**
 * Suspends the execution of this thread for a given duration.
