...
if("TRUE" STREQUAL "TRUE")
  set(abb_irb5400_support_SOURCE_PREFIX /home/luis/VT2/catkin_ws/src/abb/abb_irb5400_support)
  set(abb_irb5400_support_DEVEL_PREFIX /home/luis/VT2/catkin_ws/devel/.private/abb_irb5400_support)
  ...
  set(abb_irb5400_support_INSTALL_PREFIX /home/luis/VT2/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'abb_irb5400_support' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Shaun Edwards (Southwest Research Institute) <sedwards@swri.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'abb_irb5400_support' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/luis/VT2/catkin_ws/src/abb/abb_irb5400_support/${idir}'.  Ask the maintainer 'Shaun Edwards (Southwest Research Institute) <sedwards@swri.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/luis/VT2/catkin_ws/devel/.private/abb_irb5400_support/lib;/home/luis/VT2/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
